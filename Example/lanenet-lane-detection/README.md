...
```
python test_lanenet.py --weights_path model/tusimple/bisenetv2_lanenet/tusimple_train_miou=0.2836.ckpt-8.index --image_path ./data/tusimple_test_image/0.jpg
```
